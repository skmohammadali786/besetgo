  ...
  return (
    <div className="container mx-auto py-12 md:py-20">
        <div className="max-w-4xl mx-auto prose lg:prose-xl">
            ...
            <h2>1. Overview</h2>
            <p>This website is operated by SHILPIK.. Throughout the site, the terms “we”, “us” and “our” refer to SHILPIK.. SHILPIK. offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
